...
function Footer() {
  return (
    <footer className="w-screen text-gray-300 bg-[#2a2a2a] p-10 flex-col justify-around align-middle">
      <div className="w-full flex justify-between">
        ...
        <a
          href="hover:text-blue-500 transition duration-400"
          className="border-white border-4 p-2 px-4"
        >
          ^
        </a>
      </div>
        ...
        <div className="flex-col w-5/12">
          ...
          >
            ...
            <li className="py-2 pr-4">
              <a
                className="hover:text-blue-500 transition duration-400"
                href="https://store.epicgames.com/en-US/about"
              >
            ...
            <li className="py-2 pr-4">
              <a
                className="hover:text-blue-500 transition duration-400"
                href="https://www.epicgames.com/site/careers"
              >
                Careers
              </a>
            </li>
            ...
            <li className="py-2 pr-4">
              <a
                className="hover:text-blue-500 transition duration-400"
                href="https://www.epicgames.com/site/ux"
              >
                UX Research
              </a>
            </li>
            <li className="py-2 pr-4">
              <a
                className="hover:text-blue-500 transition duration-400"
                href="https://store.epicgames.com/en-US/eula"
              >
                Store EULA
              </a>
            </li>
            ...
            <li className="py-2 pr-4">
              <a
                className="hover:text-blue-500 transition duration-400"
                href="https://www.epicgames.com/site/news"
              >
                Epic Newsroom
              </a>
            </li>
        ...
        <div>
          ...
          >
            <li className="py-2 pr-4">
              <a
                className="hover:text-blue-500 transition duration-400"
                href="https://www.epicgames.com/battlebreakers"
              >
                Battle Breakers
              </a>
            </li>
            ...
            <li className="py-2 pr-4">
              <a
                className="hover:text-blue-500 transition duration-400"
                href="https://www.epicgames.com/site/about"
              >
                Robo Recall
              </a>
            </li>
      ...
      <div className="pt-10">
        ...
        <div className="flex justify-between">
          <ul className="flex align-middle text-xs gap-4">
            <li>
              <a
                href="/terms"
                className="hover:text-blue-500 transition duration-400"
          ...
          <ul className="flex align-middle gap-4">
            ...
            <li>
              <a href="/home">
                <SiUnrealengine className="w-10 h-10" />
              </a>
            </li>
          </ul>
        </div>
