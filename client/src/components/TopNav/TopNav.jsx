...
function TopNav() {
  ...
  return (
    <header className="w-screen bg-neutral-800 flex justify-between items-center">
      {/* Logo */}
      ...
      <nav className="flex items-center">
        <a
          ...
          className={`mx-3 text-[#ccc] p-5  ${
            selectedLink === "store" ? "border-b-4 border-blue-500" : ""
          }`}
        >
          STORE
        </a>
        <a
          ...
          href="/"
          className={`mx-3 text-[#ccc] p-5  ${
            selectedLink === "distribution" ? "border-b-4 border-blue-500" : ""
          }`}
        >
          DISTRIBUTION
        </a>
